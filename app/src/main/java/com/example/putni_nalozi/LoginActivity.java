...
public class LoginActivity extends AppCompatActivity {
    ...
    public static final String SERVER = "http://192.168.10.21:8090";



   // private PutniNaloziAPI putniNaloziAPI;
    ...
    private void provjeriLogin(User user) {
        ...
        Call<User> provjera = putniNaloziAPI.login(user);
        ...
        provjera.enqueue(new Callback<User>() {
            ...
            public void onResponse(Call<User> call, Response<User> response) {
                if (response.isSuccessful()) {
                    ...
                    if (trenutni.getRoles().equals("USER")) {
                        ...
                        intent = new Intent(LoginActivity.this, Admin_homeUI.class);
                        intent.putExtra("trenutniUser", trenutni);
